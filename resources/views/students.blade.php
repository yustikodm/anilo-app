        ...
        <div class="col-lg-12 margin-tb">
            ...
            <div class="row" style="padding: 15px">
                ...
                <div class="pull-right mb-2"  style="margin-left: 15px">
                    <a class="btn btn-primary" href="{{ route('scores') }}">Scores</a>
                </div>
                <div class="pull-right mb-2"  style="margin-left: 15px">
            ...
            <div class="modal-body">
                <form action="javascript:void(0)" id="studentForm" name="studentForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Enter student Name" maxlength="50" required="">
                        </div>
                    </div>
